 ...
 */
@Data
public class ExternalCallDto implements Serializable {
    private static final long serialVersionUID = 5823555947841173318L;
     ...
     * 问卷记录
     */
    private List<QuestionnaireDto> record;
