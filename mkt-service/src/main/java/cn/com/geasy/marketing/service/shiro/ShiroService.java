...
//
//
////            log.debug(shiroFilter.toString());
//
...
//            }
//
//            log.debug(JsonMapper.instance.toJson(this.shiroFilterFactoryBean.getFilterChainDefinitionMap()));
//        }
//    }
//
//    /**
...
//
//
////        List<SysPermission> permissions = permissionService.selectAllCaseRole();
...
////            );
////            chains.put(permission.getEndpoint(), value);
//////            chains.put(permission.getName(), value);
////        }
//        chains.put("/users", "roles[admin]");
//        chains.put("/sys/corps", "perms[corps:delete]");
//        //chains.put("/corps", "authc, roles[manager]");
//
//        chains.put("/**", "authc");
//        return chains;
//    }
