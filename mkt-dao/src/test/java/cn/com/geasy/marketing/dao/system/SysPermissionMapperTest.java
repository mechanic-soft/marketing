...
//    }
    ...
    @Test
    public void testFindAllCaseRole() {
        ...
        List<SysPermissionDto> permissions = this.permissionMapper.findAllCaseRole();
    ...
    @Test
    public void findDtoByRoleId() {



        List<SysPermissionDto> permissions = this.permissionMapper.findDtoByRoleId(2L);
...
//    })
//    @Test
//    public void testFindPageCaseRole() {
//
...
//        role3.setName("管理者");
//        role3.setDescription("理财经理的上级管理人员");
//        Page<SysPermission> page = PageUtils.getPage(1, 2);
////        Page<SysPermission> permissions = this.permissionMapper.findPageCaseRole(page);
////        assertThat(permissions.size()).isEqualTo(4);
////        assertThat(permissions.get(0).getId()).isEqualTo(1L);
////        assertThat(permissions.get(0).getName()).isEqualTo("add_user");
////        assertThat(permissions.get(0).getRoles().size()).isEqualTo(2);
