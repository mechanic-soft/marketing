...
//        @DatabaseSetup(value = "/dbunit/init/sys_corp.xml")
//})
//public class SysCorpMapperTest extends AbstractTransSpringBootDbunitTests {
//    @Autowired
//    private SysCorpMapper corpMapper;
//
//    @Test
//    public void testSelectAllPage() {
//        Page<SysCorpDto> page = PageUtils.getPage(0, 2);
//
//
////        Page<SysCorpDto> corpDtoPage = this.corpMapper.selectAllPage(null, page);
//        //SysUser sysUser = userMapper.findByUsername("admin");
//
////        assertThat(corpDtoPage).isNotNull();
//
